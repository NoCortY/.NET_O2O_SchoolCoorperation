                        ...
                        htmlStr += "<div class='col-md-12 col-sm-12 col-xs-12'>"
                                                    + "<div class='row ListriBox'>"
                                                        + "<div class='col-md-5 col-sm-6 col-xs-12 Nopadding'>"
                                                            + "<figure>"
                                                                + " <a href='detail.html?Id=" + item.Id + "&classify=" + $('#RequirementOrSupply option:selected').val() + "'>"
                                                        ...
                                                        + "<div class='col-md-7 col-sm-6 col-xs-12 Nopadding'>"
                                                            + "<div class='ListriBoxmain'>"
                                                                + "<h3><a href='detail.html?Id=" + item.Id + "&classify=" + $('#RequirementOrSupply option:selected').val() + "'>" + item.Name + "</a></h3>"
                                                                + "<p>" + item.Desc + "</p>"
                                                                + ""
